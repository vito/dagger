...
func doGitCheckout(
	...
	return finishGitCheckout(ctx, checkoutGit, remotes, cloneURL, ref, tmpref, discardGitDir)
}
...
func finishGitCheckout(ctx context.Context, checkoutGit *gitutil.GitCLI, remotes []GitRemote, cloneURL string, ref *gitutil.Ref, tmpref string, discardGitDir bool) error {
