...
func NewContainer(root *Query, pipeline pipeline.Path, platform Platform) (*Container, error) {
	if root == nil {
...
func locatePath[T *File | *Directory](
	...
	init func(*Query, *pb.Definition, string, pipeline.Path, Platform, ServiceBindings) T,
...
func (container *Container) AsTarball(
	...
	return NewFile(container.Query, pbDef, fileName, container.Pipeline, engineHostPlatform, nil), nil
}
